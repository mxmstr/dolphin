...
//  if (ch_begin_search)
//  {
//    NOTICE_LOG_FMT(VR, "begin search");
//    ch_begin_search = false;
//    ch_next_code = false;
//    ch_current_position = LoadLastPosition();
//    ch_cycles_without_snapshot = 0;
//    ERROR_LOG_FMT(VR, "ch_current_position = %d, ch_map.size = %d", ch_current_position, (int)ch_map.size());
...
//      ch_begun = false;
//
//      NOTICE_LOG_FMT(VR, "Finished bruteforcing when starting");
//      PostProcessCSVFile();
//
//      SuccessAlert(
...
//      State::Load(1);
//      ERROR_LOG_FMT(VR, "Loaded first state, prim_count = %d", original_prim_count);
//    }
//  }
